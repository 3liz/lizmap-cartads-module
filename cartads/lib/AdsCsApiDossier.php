    ...
    public function getSqlValues() {
        return '('.implode(
            ...
            array(
                ...
                $this->getAnnee(),
                "'".$this->getDateDepot()."'",
                "'".$this->getDateLimiteInstruction() ?? 'NULL'."'",
                "'".$this->getDateModificationDossier()."'",
                "'".$this->getDateAvisInstructeur() ?? 'NULL'."'",
                "'".$this->getDateDecisionSignataire() ?? 'NULL'."'",
                "'".$this->getDateNotificationDecisionSignataire() ?? 'NULL'."'",
                "'".str_replace("'", "''", $this->getStade())."'",
                "'".str_replace("'", "''", $this->getAutoriteCompetente() ?? 'NULL')."'",
                "'".str_replace("'", "''", $this->getInstructeur() ?? 'NULL')."'",
                "'".str_replace("'", "''", $this->getAvisInstructeur() ?? 'NULL')."'",
                "'".str_replace("'", "''", $this->getSignataire() ?? 'NULL')."'",
                "'".str_replace("'", "''", $this->getDecisionSignataire() ?? 'NULL')."'",
